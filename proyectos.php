        ...
        <div class="row ">
            ...
            <div class="col-sm-6 col-lg-4  px-4 py-4">
                <div class="row card">
                    ...
                    <div class="row py-5">
                        ...
                        <div class="col-6 link-proyectos">
                            <a href="https://github.com/Marcos-mi/Paginas-Programas-en-php/tree/main/sistema_ventas" target="_blank">Código fuente</a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-sm-6 col-lg-4  px-4 py-4">
                <div class="row card">
                    ...
                    <div class="col-12 py-3">
                        <p>Proyecto Full Stack desarrollado en PHP, Laravel, Javascript,  HTML, CSS,Tailwind CSS, Alpine.Js,Livewire,MVC, MySQL,docker, módulo de permisos y funcionalidades a fines.</p>
                    </div>
                    <div class="row py-5">
                        <div class="col-6">
                            <a href="#" class="btn-rojo">Ver online</a>
